...
picture = "\foxUVA\logos\picture.paa"; //Expansions Menu - 1024x512
logo = "\foxUVA\logos\logo.paa"; //Main Menu - 128x128
logoOver = "\foxUVA\logos\logoOver.paa"; //Main Menu (Mouseover)
logoSmall = "\foxUVA\logos\logoSmall.paa"; //??? - 32x32
