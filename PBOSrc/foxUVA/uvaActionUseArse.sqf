...
_arsenal = ["Open", [false, _center, _center]] spawn BIS_fnc_arsenal;
...
waitUntil {isNull (uinamespace getVariable ["BIS_fnc_arsenal_cam", objNull]) || !alive _center};
[_center, _tempCurFace, _tempCurSpeaker] call BIS_fnc_setIdentity;
...
[[_center, _tempCurFace, _tempCurSpeaker], "BIS_fnc_setIdentity"] call BIS_fnc_mp;
